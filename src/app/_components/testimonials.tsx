...
const testimonials = [
  ...
  {
    content:
      "O serviço de táxi dog foi uma mão na roda! Precisei levar o Fred para uma consulta de emergência e não tinha como sair de casa. O motorista foi super atencioso e cuidadoso, e o Fred chegou ao veterinário em segurança. Recomendo muito!",
    author: "Juliano Oliveira",
    role: "Tutor do Fred (Shih Tzu)",
    image: tutor4,
  }
]
...
export function Testimonials() {
  ...
  return (
    <main className='bg-[#FFD449] py-16'>
